import { Dimensions, Image, KeyboardAvoidingView, Pressable, ScrollView, StyleSheet, Text, TextInput, View, Platform, Switch } from 'react-native';
      ...
      >
        <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
          ...
          <View style={styles.bodyContainer}>
            <Ionicons name={"lock-closed-outline"} style={{ marginBottom: 40 }} color={COLORS.text} size={70} />
            ...
            <TextInput
              style={[styles.input, focusInput === 'confirm password' && { borderColor: COLORS.primary }]}
